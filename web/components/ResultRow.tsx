...
export function ResultRow({ product }: { product: Product }) {
  ...
  return (
    <div className="flex cursor-pointer items-center gap-3.5 rounded-2xl border border-black/[0.08] bg-white/80 p-3.5 backdrop-blur-lg transition-all hover:border-black/20 hover:shadow-[0_6px_20px_rgba(0,0,0,0.06)]">
